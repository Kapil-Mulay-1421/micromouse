...
void setup() {
    ...
    const std::set<std::pair<std::pair<int, int>, std::pair<int, int>>> known_walls = readWallsFromEEPROM();

    Mouse mouse(start_point.first, start_point.second, known_walls, goal, maze, {}, "right_first");
